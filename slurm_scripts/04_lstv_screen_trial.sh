...
set -x
echo "================================================================"
echo "LSTV Screening Pipeline - TRIAL RUN (5 studies) - FIXED v1.1"
...
echo "================================================================"
echo "Starting LSTV screening (TRIAL - 5 studies) - FIXED v1.1"
echo "Mode: 3-VIEW SPINE-AWARE (matches training pipeline)"
